...
/* harmony import */ var _skills_FRW_SKILL_md__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
/* harmony import */ var _skills_FRW_references_form_md__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6);
/* harmony import */ var _skills_FRW_references_bind_md__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7);
/* harmony import */ var _skills_FRW_references_transmission_md__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8);
...
const REFERENCES = {
    'references/form.md': _skills_FRW_references_form_md__WEBPACK_IMPORTED_MODULE_5__,
    'references/bind.md': _skills_FRW_references_bind_md__WEBPACK_IMPORTED_MODULE_6__,
    'references/transmission.md': _skills_FRW_references_transmission_md__WEBPACK_IMPORTED_MODULE_7__,
};
async function deploySkill() {
    ...
    const skillsDir = vscode__WEBPACK_IMPORTED_MODULE_0__.Uri.joinPath(folders[0].uri, '.claude', 'skills');
    ...
    await write('FRW/SKILL.md', _skills_FRW_SKILL_md__WEBPACK_IMPORTED_MODULE_4__);
    const claudeMdUri = vscode__WEBPACK_IMPORTED_MODULE_0__.Uri.joinPath(folders[0].uri, 'CLAUDE.md');
...
function activate(context) {
    let currentPanel;
    let disposable = vscode__WEBPACK_IMPORTED_MODULE_0__.commands.registerCommand("vscode-mtess-frw-bacasable.open", () => {
    ...
    const config = vscode__WEBPACK_IMPORTED_MODULE_0__.workspace.getConfiguration("mtessFrwBacasable");
    if (config.get("deployClaudeCodeSkill") !== false) {
        deploySkill();
    }
    context.subscriptions.push(vscode__WEBPACK_IMPORTED_MODULE_0__.commands.registerCommand('vscode-mtess-frw-bacasable.init', async () => {
        ...
        if (cfg.get("deployClaudeCodeSkill") === false) {
            vscode__WEBPACK_IMPORTED_MODULE_0__.window.showInformationMessage('FRW: déploiement du skill Claude Code désactivé dans les paramètres.');
            return;
        }
        await deploySkill();
        vscode__WEBPACK_IMPORTED_MODULE_0__.window.showInformationMessage('FRW: skill Claude Code déployé dans .claude/skills/');
    }));
}
